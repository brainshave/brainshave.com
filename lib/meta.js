...
function href (path) {
  // We want to have clean urls without html extension. It requires
  // server to have proper rewrites set (GitHub Pages does that)
  return path.replace(extension_matcher, '');
}
